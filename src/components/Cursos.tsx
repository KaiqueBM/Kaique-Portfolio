    ...
    <div className="text-black" id="cursos">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="font-overpass font-light bg-slate-100 border-l-4 border-sky-900 p-3 mt-5 mb-5 lg:w-6/12 w-11/12 rounded-r-lg shadow-md hover:bg-sky-900 hover:text-white hover:border-slate-100 transition duration-500">
          ...
          <div>Mai/2023 - Mai/2023</div>
          <div>+ Conceitos de Outsystem;</div>
          <div>+ Service studio, estruturas, entidades e atributos;</div>
          <div>+ Aggregates, expressions, banco de dados e funções;</div>
        </div>
        ...
        <div className="font-overpass font-light bg-slate-100 border-l-4 border-sky-900 p-3 mb-5 lg:w-6/12 w-11/12 rounded-r-lg shadow-md hover:bg-sky-900 hover:text-white hover:border-slate-100 transition duration-500">
          <div>
            <span className="font-semibold">Curso de VUE 3</span>- Youtube
          ...
          <div>
            + Lifecycle hooks, hierarquia de componentes, diretivas, atributos
            dinâmicos, métodos, CSS scoped e global, eventos, prop, emit e mais;
          </div>
          <div>
            + Criação de API com JSON server e implementação do Vue Router.
          </div>
        </div>
        ...
        <div className="font-overpass font-light bg-slate-100 border-l-4 border-sky-900 p-3 mb-5 lg:w-6/12 w-11/12 rounded-r-lg shadow-md hover:bg-sky-900 hover:text-white hover:border-slate-100 transition duration-500">
          ...
          <div>
            + Criação de templates de páginas, página de blog, de pesquisa e
            mais;
          </div>
          <div>
            + Template parts, theme customizer e internacionalização/localização
            do tema;
          </div>
          <div>
            + Melhores práticas de segurança, migração do servidor e WP com
            docker.
          </div>
        </div>
        ...
        <div className="font-overpass font-light bg-slate-100 border-l-4 border-sky-900 p-3 mb-5 lg:w-6/12 w-11/12 rounded-r-lg shadow-md hover:bg-sky-900 hover:text-white hover:border-slate-100 transition duration-500">
          ...
          <div>
            + Criar sites com as melhores práticas com HTML, CSS e Javascript;
          </div>
          <div>
            + Utilização de bibliotecas para mais agilidade como Bootstrap e
            JQuery;
          </div>
          <div>
            + Dominando a criação de aplicativos web com o React e Redux;
          </div>
          <div>
            + Criação de sistemas web dinâmicos e complexos que rodam no backend
            com Node.Js e desenvolvimento de aplicações REST;
          </div>
          <div>
            + Desenvolvimento de banco de dados utilizando Firebase e MongoDB.
          </div>
        </div>
        ...
        <div className="font-overpass font-light bg-slate-100 border-l-4 border-sky-900 p-3 mb-5 lg:w-6/12 w-11/12 rounded-r-lg shadow-md hover:bg-sky-900 hover:text-white hover:border-slate-100 transition duration-500">
          ...
          <div>
            + Criação de tabelas e gráficos utilizando bibliotecas como
            Matplotlib, Seaborn e Pandas;
          </div>
          <div>
            + Conceitos e primeiros passos de inteligencia artificial em Python
            com Scikit-learn
          </div>
        </div>
        ...
        <div className="font-overpass font-light bg-slate-100 border-l-4 border-sky-900 p-3 mb-5 lg:w-6/12 w-11/12 rounded-r-lg shadow-md hover:bg-sky-900 hover:text-white hover:border-slate-100 transition duration-500">
          <div>
            <span className="font-semibold">Curso de git e github</span>- uDemy
            (Willian Justen de Vasconcellos)
          </div>
          <div>Mai/2022 - mai/2022</div>
          <div>+ Conceitos de git, controle de versão e ciclo de vida</div>
          <div>
            + Fazendo commits, visualizando logs e diffs, clonando repositórios
            e fork;
          </div>
          <div>
            + Ramificação (branch), git stash, revert e conceitos avançados.
          </div>
        </div>
        ...
        <div className="font-overpass font-light bg-slate-100 border-l-4 border-sky-900 p-3 mb-5 lg:w-6/12 w-11/12 rounded-r-lg shadow-md hover:bg-sky-900 hover:text-white hover:border-slate-100 transition duration-500">
          <div>
            ...
            - EuCodo (curso ainda está sendo produzido sempre com novos
            conteúdos)
          </div>
